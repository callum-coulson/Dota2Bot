...
----------------------------------------------------------------------------------------------------
function ConsiderBatteryFighting(EnemyToKill)

return 1;

end

--[[function ConsiderCogFighting(EnemyToKill)

return 1;

end

function ConsiderRocketFighting(abilityRF,EnemyToKill);

return 1;

end

function ConsiderHookFighting(abilityHook,EnemyToKill);
